      ...
      <div className="shell">
        <div className="parent-band">
          <div className="pb-lead">
            ...
            <p className="pb-copy">
              ...
              <br />
              会社概要・宴会場「料亭 横浜銀泉亭」のご案内・採用情報等は、本社コーポレートサイトをご覧ください。
            </p>
          </div>
          <a
            className="pb-link"
        ...
        <div className="grid">
          <div className="brand">
            ...
            <p style={{ marginTop: 0 }}>
              昭和四十九年創業。横浜・保土ヶ谷の地にて、冠婚葬祭料理のケータリング・仕出し・各種出張パーティを承って参りました。団体様向け宴会施設「料亭　横浜銀泉亭」も併せてご利用頂けます。
            </p>
            <div className="offices">
              <div className="office">
                <div className="o-label">横浜本社　／　料亭 横浜銀泉亭</div>
