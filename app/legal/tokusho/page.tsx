    ...
    },
    {
      ...
      td: (
        <>
          ...
          <br />
          ケータリング・お届け弁当：配達料はご注文金額に含めてご提示致します
          <br />
    ...
    },
    {
      ...
      td: (
        <>
          クレジットカード：ご注文確定時
          <br />
          銀行振込（前払い）：ご注文確定後、7日以内にお振込みください
          <br />
          銀行振込（後日一括）：お届け後、ご請求書記載の期日までにお振込みください
          <br />
          現金：お届け当日にお支払いください
        </>
      ),
    },
    {
      ...
      td: (
        <>
          【お届け弁当（神奈川・東京）】
          <br />
          ご希望日の2日前17時までにご注文ください。お急ぎの場合はお電話にてご相談ください。
          <br />
          <br />
          【フルケータリング（神奈川・東京）】
          <br />
          ご希望日の1週間前までにご相談ください。仕入れ・お仕立ての段取りに必要なお日にちです。
          <br />
          <br />
          【冷凍便・全国配送】
          <br />
